...
import { IconDashboard, IconSettings, IconGroup, IconGithub, IconPlugin, IconSun, IconSteam, IconGame } from './icons'
...
const menuItems: { id: PageId; label: string; icon: React.ReactNode }[] = [
    ...
    { id: 'steam', label: 'Steam 管理', icon: <IconSteam size={18} /> },
    { id: 'gameNames', label: '游戏名管理', icon: <IconGame size={18} /> },
    ...
    return (
        <aside className="w-60 flex-shrink-0 bg-white dark:bg-[#1a1b1d] border-r border-gray-200 dark:border-gray-800 flex flex-col">
            ...
            <div className="px-3 pb-2">
                <a
                    href="https://github.com/AliubYiero/napcat-plugin-steam-online-listener"
                    target="_blank"
